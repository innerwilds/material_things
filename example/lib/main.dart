...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final CountryEditingController _countryController = CountryEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Are you from ${_country?.fullName ?? '*country*'}?'
        ),
      ),
      body: Center(
        child: Column(
                ...
                child: Column(
                  children: [
                    ...
                    CountryButton(
                      ...
                      onTap: () async {
                        final country = await Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return SelectCountryPage(
                              ...
                              restrictedReasons: {
                                const Country(1, 'US', 'United States'): 'White House is not red...',
                              },
                            );
                          },
                        ));
