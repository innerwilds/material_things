...
class _SelectCountryPageState extends State<SelectCountryPage> {
  ...
  TextEditingController get effectiveController => widget.searchController ?? _controller!;
    ...
    return Scaffold(
      appBar: AppBar(
              ...
              ListenableBuilder(
                ...
                builder: (context, child) {
                  return AnimatedSwitcher(
                    duration: const Duration(milliseconds: 120),
                    child: effectiveController.text.isEmpty ? null : IconButton(
        ...
        actions: [
          AnimatedSwitcher(
            duration: const Duration(milliseconds: 120),
            child: _searchModeEnabled ? null : IconButton(
              onPressed: () => setState(() {
      ...
      body: AnimatedSwitcher(
        ...
        child: ListView.separated(
          ...
          separatorBuilder: (context, index) {
            ...
            final nextCountry = index + 1 < _filteredCountries.length ? _filteredCountries[index + 1] : null;

            if (nextCountry?.fullName.characters.first != currentCountry.fullName.characters.first) {
              return Divider();
            }
          ...
          itemBuilder: (context, index) {
            ...
            if (widget.restrictMode == RestrictMode.disableChoose && _isRestricted(country)) {
              onTap = null;
