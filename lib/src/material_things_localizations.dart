...
abstract class MaterialThingsLocalizations {
  ...
  static MaterialThingsLocalizations of(BuildContext context) {
    return Localizations.of<MaterialThingsLocalizations>(context, MaterialThingsLocalizations)!;
  }
...
final class _MaterialThingsLocalizationsEn implements MaterialThingsLocalizations {
