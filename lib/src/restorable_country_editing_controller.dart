...
/// collected.
class RestorableCountryEditingController extends RestorableChangeNotifier<CountryEditingController> {
  /// Creates a [RestorableCountryEditingController].
  ///
  /// This constructor treats a null `text` argument as if it were the empty
  /// string.
  factory RestorableCountryEditingController({
    Country? country,
  }) => RestorableCountryEditingController.fromValue(
    country == null ? CountryEditingValue.empty : CountryEditingValue(country: country),
  );
  ...
  RestorableCountryEditingController.fromValue(CountryEditingValue value) : _initialValue = value;
