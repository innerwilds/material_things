...
class _PhoneFieldState extends State<PhoneField> with RestorationMixin {
  ...
  void _mayAutoFormat() {
    if (widget.autoFormat) {
      final formatter = _DefaultPhoneFieldNsnInputFormatter(_effectiveController);
    ...
    countryField = IntrinsicWidth(
      child: ConstrainedBox(
        constraints: BoxConstraints(
          minWidth: countryFieldMaxWidth,
        ),
        child: countryField,
      ),
    );

    Widget buildTextField(BuildContext context, PhoneEditingValue value, Widget? _) {
      return TextField(
        groupId: widget.groupId,
        decoration: InputDecoration(
          border: InputBorder.none,
        ...
        maxLength: widget.autoFormat
            ? value.country?.format?.length ??
            widget.maxNsnLength
            : widget.maxNsnLength,
...
class _DefaultPhoneFieldNsnInputFormatter extends TextInputFormatter {
  ...
  Iterable<int>? get spacePositions => controller.country?.format
  ...
  TextEditingValue _format(TextEditingValue value) {
    ...
    return TextEditingValue(
      ...
      selection:
      TextSelection.collapsed(offset: withSpacesInRightPlaces.length),
...
class _PhoneFormFieldState extends FormFieldState<PhoneFormFieldResult> {
  ...
  PhoneEditingController get _effectiveController => _phoneFormField.controller ?? _controller!.value;
