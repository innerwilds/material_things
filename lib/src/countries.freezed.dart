...
class _$CountryImpl extends _Country {
  const _$CountryImpl(this.phoneCountryCode, this.twoLetterCode, this.fullName,
      [this.format])
      : super._();
...
abstract class _Country extends Country {
  const factory _Country(final int phoneCountryCode, final String twoLetterCode,
      final String fullName,
      [final String? format]) = _$CountryImpl;
