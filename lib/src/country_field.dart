...
Country? _defaultUserInputFindCountry(String input, List<Country> countries,
  ...
  if (MaterialThingsBindings.instance.isInitialized) {
    ...
    MaterialThingsBindings.instance
        .ensureInitialized()
...
class _CountryFieldState extends State<CountryField> with RestorationMixin {
  ...
  void _onExternallyCountryChange() {
    ...
    _textFieldController.text =
        widget.displayCountry(widget.type, _effectiveController.country);
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      keyboardType: widget.keyboardType == TextInputType.none && widget.type == CountryFieldType.plusSignPrefixedPhoneCode ? TextInputType.number : widget.keyboardType,
