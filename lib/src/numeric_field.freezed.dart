...
abstract class $NumericEditingValueCopyWith<$Res> {
  factory $NumericEditingValueCopyWith(
          NumericEditingValue value, $Res Function(NumericEditingValue) then) =
      _$NumericEditingValueCopyWithImpl<$Res, NumericEditingValue>;
  @useResult
  $Res call({BigInt? number, bool isValid, int length, int focusedDigit});
}
    ...
    return _then(_value.copyWith(
      ...
      length: null == length
          ...
          : length // ignore: cast_nullable_to_non_nullable
              as int,
      focusedDigit: null == focusedDigit
          ? _value.focusedDigit
...
abstract class _$$NumericEditingValueImplCopyWith<$Res>
    implements $NumericEditingValueCopyWith<$Res> {
  factory _$$NumericEditingValueImplCopyWith(_$NumericEditingValueImpl value,
...
class __$$NumericEditingValueImplCopyWithImpl<$Res>
  ...
  __$$NumericEditingValueImplCopyWithImpl(_$NumericEditingValueImpl _value,
  ...
  $Res call({
    ...
    return _then(_$NumericEditingValueImpl(
      number: freezed == number
          ? _value.number
          : number // ignore: cast_nullable_to_non_nullable
              as BigInt?,
...
class _$NumericEditingValueImpl implements _NumericEditingValue {
  ...
  @override
  String toString() {
    return 'NumericEditingValue(number: $number, isValid: $isValid, length: $length, focusedDigit: $focusedDigit)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, number, isValid, length, focusedDigit);
...
abstract class _NumericEditingValue implements NumericEditingValue {
  const factory _NumericEditingValue(
      ...
      final int focusedDigit}) = _$NumericEditingValueImpl;
